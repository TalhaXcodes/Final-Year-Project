...
const categories = [
    ...
    { label: "General Gift Baskets", value: "Gift Baskets", icon: Gift },
    { label: "Flower Bouquets", value: "Flower Bouquets", icon: Flower2 },
    { label: "Perfume Sets", value: "Perfume Sets", icon: SprayCan },
    { label: "Makeup Hampers", value: "Makeup Hampers", icon: Sparkles },
    { label: "Chocolate Gifts", value: "Chocolate Gifts", icon: Candy },
    { label: "Baby Gifts", value: "Baby Gifts", icon: Baby },
                            ...
                            return (
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            <Heart
                                                className={`w-5 h-5 text-rose-600 ${isFavourite ? "fill-rose-600" : ""
                                                    }`}
                                            />
                                        </button>
                                    ...
                                    <div className="p-5">
                                        <div className="flex items-center justify-between gap-3 mb-2">
                                            ...
                                            <p
                                                className={`text-xs font-medium ${isOutOfStock ? "text-gray-500" : "text-green-600"
                                                    }`}
                                            >
                                                {isOutOfStock
                                                    ? "Unavailable"
